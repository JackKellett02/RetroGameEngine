...
public:
	...
	GameObject();
	GameObject(RTMATH::Vector2 a_v2Pos, RTMATH::Vector2 a_v2Dimensions, float a_fRotation, bool a_bActiveState, GameObject* a_oParent, TextureManager* a_tTextureManager, std::string texturePath);
	...
	//Setters
	void SetPos(RTMATH::Vector2 a_v2Position);
	...
	void TranslatePos(RTMATH::Vector2 a_v2Movement);
	void TransformDimensions(RTMATH::Vector2 a_v2DimensionChange);
